...
1. **Strict Validation**: Always run `pnpm run check` before finalizing tasks. This handles linting, typechecking, building, Vitest unit tests, and Playwright E2E validations. 
