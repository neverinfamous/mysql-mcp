...
for (const file in toolMap) {
  if (!file.startsWith('test-codemode-') && !file.startsWith('test-advanced-') && !file.startsWith('test-usability-') && file !== 'test-codemode.md') {
...
console.log('--- OVERLAPS (In multiple basic test-tool-groups) ---');
const toolCounts = {};
