...
**Immediately read** `k8s-ssi/agent-install/SKILL.md` now, then `k8s-ssi/enable-ssi/SKILL.md`, then `k8s-ssi/verify-ssi/SKILL.md` — do not proceed from memory.
...
**Immediately read** `linux-ssi/agent-install/SKILL.md` now, then `linux-ssi/enable-ssi/SKILL.md`, then `linux-ssi/verify-ssi/SKILL.md` — do not proceed from memory.
...
**Immediately read** `service-remapping/SKILL.md` now — do not proceed from memory.
