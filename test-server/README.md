...
| `test-tool-groups/`          | **Standard tests** — Multiple self-contained modular prompts for direct MCP tool call validation                                                    | When testing individual tool groups          |
...
| `test-usability/`            | **Usability tests** — Multiple prompts for hallucination fuzzing and UX validation via Code Mode                                                                     | When testing UX                              |
| `test-advanced/`             | **Advanced stress tests** — Multiple files for boundary values, state pollution, and payload monitoring (Code Mode only)                            | After group checklists pass                  |
