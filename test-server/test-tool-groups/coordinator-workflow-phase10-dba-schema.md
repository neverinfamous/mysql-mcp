# MySQL MCP Tool Groups Testing - Phase 10: Dba-schema
...
1. **State Management:** Before starting, create a `task.md` artifact with the 7 tests listed below as a checklist. Update it after each test.
...
3. **Reporting:** When a subagent finishes, kill it to save context. You MUST report progress to me using this exact format:
   `Test X (<name>) out of 7: A Prompt Fixes / B Code Fixes / C Infrastructure Absent`
...
Follow the rules in `coordinator-workflow-phase10-dba-schema.md`, subject to these strict overrides:
...
5. `test-migration-part1.md`
6. `test-migration-part2.md`
7. `test-migration-part3.md`
