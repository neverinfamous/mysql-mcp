# mysql-mcp Tool Group Testing: PART 2 [core]
...
5. **Commit**: Stage and commit all changes — do NOT push. **CRITICAL**: Your commit message MUST explicitly include the name of this tool group prompt file (e.g. `[Testing: test-core.md]`) so the history can be traced.
