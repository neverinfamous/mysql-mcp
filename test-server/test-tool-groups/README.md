...
Begin with any requested group prompt from this folder (e.g. `test-admin-audit.md`), and execute the deterministic checklist line-by-line using direct tool calls only.
