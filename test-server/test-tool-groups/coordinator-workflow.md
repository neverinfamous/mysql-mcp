...
7. **Coordinator Progress Reporting**:
   - The Coordinator MUST respond to the user as each test proceeds and include the running count: This is test X out of Y. X fixes applied [Y Prompt / Z Code] [W Graceful Fails]: <concise description>. Do not wrap the message in quotes or add preamble.
