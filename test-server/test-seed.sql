...
--
-- Target: testdb database on mysql-node1 (cluster) or mysql (standalone) Docker container
...
-- =============================================================================
-- Queries binlog status and replica info — available on standalone by default.

-- =============================================================================
-- CLUSTER RESOURCE: No seed needed
-- =============================================================================
-- Queries Group Replication — returns "not configured" on standalone mysql.
