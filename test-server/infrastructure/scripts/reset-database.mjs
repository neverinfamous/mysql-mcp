...
const filesToClean = [
    ...
    { path: resolve(__dirname, '../../../test-metrics-registry.sqlite') },
    { path: resolve(__dirname, '../../../test-metrics-registry.sqlite-journal') },
    { path: resolve(__dirname, '../../../test-metrics-registry.sqlite-shm') },
    { path: resolve(__dirname, '../../../test-metrics-registry.sqlite-wal') }
];
