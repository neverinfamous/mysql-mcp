...
Read the main help resource `mysql://help`. Report:
- Did it succeed?
- Approximate character count of the content
- First 3 lines of content

Then read ONE group-specific help resource (e.g., `mysql://help/core`, `mysql://help/json`, or whichever is available). Report:
...
Read the schema resource `mysql://schema`. Report:
- Did it succeed?
