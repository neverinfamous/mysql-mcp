...
6. **Commit**: Commit all changes locally using `bun .\\.agents\\scripts\\commit.ts --msg "test({{COMMIT_SCOPE}}): ..." --impact 0.1 --confidence 1.0 --validation passed --journal --add .`. Do NOT push.
