...
> [!WARNING]
> **DO NOT EDIT THIS FILE DIRECTLY.** A template generates this file. You must edit `test-server/scripts/prompt-template.md` to fix errors. Then, re-run `standardize-prompts.js`.
