# MySQL MCP Advanced Stress Testing: [advanced-monitoring-status]
...
|---|---|---|
| `mysql.advanced-monitoring-status.replicationStatus` |   |   |
| `mysql.advanced-monitoring-status.poolStats` |   |   |
| `mysql.advanced-monitoring-status.serverHealth` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-monitoring-status.replicationStatus
- [ ] Ensure full coverage for mysql.advanced-monitoring-status.poolStats
- [ ] Ensure full coverage for mysql.advanced-monitoring-status.serverHealth
