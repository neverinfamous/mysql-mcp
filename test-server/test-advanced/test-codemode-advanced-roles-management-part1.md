# MySQL MCP Advanced Stress Testing: [advanced-roles-management]
...
|---|---|---|
| `mysql.advanced-roles-management.roleGrant` |   |   |
| `mysql.advanced-roles-management.roleAssign` |   |   |
| `mysql.advanced-roles-management.roleRevoke` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-roles-management.roleGrant
- [ ] Ensure full coverage for mysql.advanced-roles-management.roleAssign
- [ ] Ensure full coverage for mysql.advanced-roles-management.roleRevoke
