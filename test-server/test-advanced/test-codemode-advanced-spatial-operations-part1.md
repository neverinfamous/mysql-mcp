# MySQL MCP Advanced Stress Testing: [advanced-spatial-operations]
...
|---|---|---|
| `mysql.advanced-spatial-operations.spatialDistance` |   |   |
| `mysql.advanced-spatial-operations.spatialDistanceSphere` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-spatial-operations.spatialDistance
- [ ] Ensure full coverage for mysql.advanced-spatial-operations.spatialDistanceSphere
