# MySQL MCP Advanced Stress Testing: [advanced-stats-time-series]
...
|---|---|---|
| `mysql.advanced-stats-time-series.statsTimeSeries` |   |   |
| `mysql.advanced-stats-time-series.statsMovingAvg` |   |   |
| `mysql.advanced-stats-time-series.statsRunningTotal` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-stats-time-series.statsTimeSeries
- [ ] Ensure full coverage for mysql.advanced-stats-time-series.statsMovingAvg
- [ ] Ensure full coverage for mysql.advanced-stats-time-series.statsRunningTotal
