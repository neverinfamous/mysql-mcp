# MySQL MCP Advanced Stress Testing: [advanced-proxysql-status]
...
|---|---|---|
| `mysql.advanced-proxysql-status.proxysqlGlobalVariables` |   |   |
| `mysql.advanced-proxysql-status.proxysqlRuntimeStatus` |   |   |
| `mysql.advanced-proxysql-status.proxysqlMemoryStats` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-proxysql-status.proxysqlGlobalVariables
- [ ] Ensure full coverage for mysql.advanced-proxysql-status.proxysqlRuntimeStatus
- [ ] Ensure full coverage for mysql.advanced-proxysql-status.proxysqlMemoryStats
