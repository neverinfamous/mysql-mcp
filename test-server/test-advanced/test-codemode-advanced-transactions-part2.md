# MySQL MCP Advanced Stress Testing: [advanced-transactions]
...
|---|---|---|
| `mysql.advanced-transactions.transactionRelease` |   |   |
| `mysql.advanced-transactions.transactionRollbackTo` |   |   |
| `mysql.advanced-transactions.transactionExecute` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-transactions.transactionRelease
- [ ] Ensure full coverage for mysql.advanced-transactions.transactionRollbackTo
- [ ] Ensure full coverage for mysql.advanced-transactions.transactionExecute
