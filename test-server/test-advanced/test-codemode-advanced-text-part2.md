...
|---|---|---|
| `mysql.advanced-text.soundex` |   |   |
| `mysql.advanced-text.substring` |   |   |
| `mysql.advanced-text.concat` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-text.soundex
- [ ] Ensure full coverage for mysql.advanced-text.substring
- [ ] Ensure full coverage for mysql.advanced-text.concat
