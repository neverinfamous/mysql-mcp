...
|---|---|---|
| `mysql.advanced-schema-views.listViews` |   |   |
| `mysql.advanced-schema-views.createView` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-schema-views.listViews
- [ ] Ensure full coverage for mysql.advanced-schema-views.createView
