...
|---|---|---|
| `mysql.advanced-proxysql-status.proxysqlCommands` |   |   |
| `mysql.advanced-proxysql-status.proxysqlProcessList` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-proxysql-status.proxysqlCommands
- [ ] Ensure full coverage for mysql.advanced-proxysql-status.proxysqlProcessList
