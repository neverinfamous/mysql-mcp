...
|---|---|---|
| `mysql.advanced-backup-audit.auditDiffBackup` |   |   |
| `mysql.advanced-backup-audit.restoreDump` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-backup-audit.auditDiffBackup
- [ ] Ensure full coverage for mysql.advanced-backup-audit.restoreDump
