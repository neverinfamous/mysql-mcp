# MySQL MCP Advanced Stress Testing: [advanced-router-routes]
...
|---|---|---|
| `mysql.advanced-router-routes.routerRouteDestinations` |   |   |
| `mysql.advanced-router-routes.routerRouteBlockedHosts` |   |   |
| `mysql.advanced-router-routes.routerMetadataStatus` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-router-routes.routerRouteDestinations
- [ ] Ensure full coverage for mysql.advanced-router-routes.routerRouteBlockedHosts
- [ ] Ensure full coverage for mysql.advanced-router-routes.routerMetadataStatus
