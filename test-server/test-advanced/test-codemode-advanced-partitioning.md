...
9. `mysql.partitioning.reorganizePartition({table: "test_partitioned", fromPartitions: ["nonexistent_p99"], partitionType: "RANGE", toPartitions: [{name: "p_new", value: "1,2"}]})` → verify structured `{success: false}`
