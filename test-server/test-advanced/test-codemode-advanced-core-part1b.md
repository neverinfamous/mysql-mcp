# MySQL MCP Advanced Stress Testing: [advanced-core]
...
|---|---|---|
| `mysql.advanced-core.describeTable` |   |   |
| `mysql.advanced-core.createTable` |   |   |
| `mysql.advanced-core.dropTable` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-core.describeTable
- [ ] Ensure full coverage for mysql.advanced-core.createTable
- [ ] Ensure full coverage for mysql.advanced-core.dropTable
