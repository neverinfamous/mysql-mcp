# MySQL MCP Advanced Stress Testing: [advanced-schema-routines]
...
|---|---|---|
| `mysql.advanced-schema-routines.listStoredProcedures` |   |   |
| `mysql.advanced-schema-routines.listFunctions` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-schema-routines.listStoredProcedures
- [ ] Ensure full coverage for mysql.advanced-schema-routines.listFunctions
