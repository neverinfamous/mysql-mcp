...
|---|---|---|
| `mysql.advanced-shell-data.mysqlshDumpTables` |   |   |
| `mysql.advanced-shell-data.mysqlshLoadDump` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-shell-data.mysqlshDumpTables
- [ ] Ensure full coverage for mysql.advanced-shell-data.mysqlshLoadDump
