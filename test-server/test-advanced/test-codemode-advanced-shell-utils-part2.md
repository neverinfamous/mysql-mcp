# MySQL MCP Advanced Stress Testing: [advanced-shell-utils]
...
|---|---|---|
| `mysql.advanced-shell-utils.mysqlshDumpInstance` |   |   |
| `mysql.advanced-shell-utils.mysqlshDumpSchemas` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-shell-utils.mysqlshDumpInstance
- [ ] Ensure full coverage for mysql.advanced-shell-utils.mysqlshDumpSchemas
