# MySQL MCP Advanced Stress Testing: [advanced-stats-window]
...
|---|---|---|
| `mysql.advanced-stats-window.statsRowNumber` |   |   |
| `mysql.advanced-stats-window.statsRank` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-stats-window.statsRowNumber
- [ ] Ensure full coverage for mysql.advanced-stats-window.statsRank
