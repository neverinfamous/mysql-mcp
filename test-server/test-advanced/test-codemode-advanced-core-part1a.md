...
|---|---|---|
| `mysql.advanced-core.readQuery` |   |   |
| `mysql.advanced-core.writeQuery` |   |   |
| `mysql.advanced-core.listTables` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-core.readQuery
- [ ] Ensure full coverage for mysql.advanced-core.writeQuery
- [ ] Ensure full coverage for mysql.advanced-core.listTables
