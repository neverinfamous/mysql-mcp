# MySQL MCP Advanced Stress Testing: [advanced-backup-audit]
...
|---|---|---|
| `mysql.advanced-backup-audit.auditListBackups` |   |   |
| `mysql.advanced-backup-audit.auditRestoreBackup` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-backup-audit.auditListBackups
- [ ] Ensure full coverage for mysql.advanced-backup-audit.auditRestoreBackup
