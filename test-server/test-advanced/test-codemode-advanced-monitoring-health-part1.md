# MySQL MCP Advanced Stress Testing: [advanced-monitoring-health]
...
|---|---|---|
| `mysql.advanced-monitoring-health.showProcesslist` |   |   |
| `mysql.advanced-monitoring-health.showStatus` |   |   |
| `mysql.advanced-monitoring-health.showVariables` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-monitoring-health.showProcesslist
- [ ] Ensure full coverage for mysql.advanced-monitoring-health.showStatus
- [ ] Ensure full coverage for mysql.advanced-monitoring-health.showVariables
