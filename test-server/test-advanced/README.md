...
0. **Anti-Hallucination Guardrails:** The Coordinator MUST read the exact filenames from `coordinator-workflow.md`. Subagents MUST output `STATUS: SUCCESS` or `STATUS: FAILED_FILE_NOT_FOUND`. The Coordinator MUST halt if a file is not found.
