# MySQL MCP Advanced Stress Testing: [advanced-performance-analysis]
...
|---|---|---|
| `mysql.advanced-performance-analysis.indexUsage` |   |   |
| `mysql.advanced-performance-analysis.tableStats` |   |   |
| `mysql.advanced-performance-analysis.bufferPoolStats` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-performance-analysis.indexUsage
- [ ] Ensure full coverage for mysql.advanced-performance-analysis.tableStats
- [ ] Ensure full coverage for mysql.advanced-performance-analysis.bufferPoolStats
