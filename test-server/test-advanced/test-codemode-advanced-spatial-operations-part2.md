...
|---|---|---|
| `mysql.advanced-spatial-operations.spatialBuffer` |   |   |
| `mysql.advanced-spatial-operations.spatialTransform` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-spatial-operations.spatialBuffer
- [ ] Ensure full coverage for mysql.advanced-spatial-operations.spatialTransform
