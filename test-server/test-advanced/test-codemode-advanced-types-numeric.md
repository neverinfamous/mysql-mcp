# mysql-mcp Advanced Stress Testing: [types-numeric]
...
1. Test inserting and reading numeric data (TINYINT, INT, BIGINT, DECIMAL, FLOAT, DOUBLE) using `mysql_execute_code`.
2. Ensure precision is maintained for DECIMAL and BIGINT.
3. Check out of range errors and strict mode enforcement.
