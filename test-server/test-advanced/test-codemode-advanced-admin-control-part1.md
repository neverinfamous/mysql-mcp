# MySQL MCP Advanced Stress Testing: [advanced-admin-control]
...
|---|---|---|
| `mysql.advanced-admin-control.optimizeTable` |   |   |
| `mysql.advanced-admin-control.analyzeTable` |   |   |
| `mysql.advanced-admin-control.checkTable` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-admin-control.optimizeTable
- [ ] Ensure full coverage for mysql.advanced-admin-control.analyzeTable
- [ ] Ensure full coverage for mysql.advanced-admin-control.checkTable
