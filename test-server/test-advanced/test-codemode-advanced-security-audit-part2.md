...
|---|---|---|
| `mysql.advanced-security-audit.securityMaskData` |   |   |
| `mysql.advanced-security-audit.securityPasswordValidate` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-security-audit.securityMaskData
- [ ] Ensure full coverage for mysql.advanced-security-audit.securityPasswordValidate
