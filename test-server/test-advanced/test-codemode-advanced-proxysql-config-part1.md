...
|---|---|---|
| `mysql.advanced-proxysql-config.proxysqlStatus` |   |   |
| `mysql.advanced-proxysql-config.proxysqlServers` |   |   |
| `mysql.advanced-proxysql-config.proxysqlQueryRules` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-proxysql-config.proxysqlStatus
- [ ] Ensure full coverage for mysql.advanced-proxysql-config.proxysqlServers
- [ ] Ensure full coverage for mysql.advanced-proxysql-config.proxysqlQueryRules
