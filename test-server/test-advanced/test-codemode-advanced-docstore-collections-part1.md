# MySQL MCP Advanced Stress Testing: [advanced-docstore-collections]
...
> [!WARNING]
> **DO NOT EDIT THIS FILE DIRECTLY.** This file is generated from a template. (If you are editing `prompt-template.md`, ignore this warning.) You must edit `test-server/scripts/prompt-template.md` to fix errors. Then, re-run `bun test-server/scripts/generate-tests.ts`.
...
|---|---|---|
| `mysql.advanced-docstore-collections.docListCollections` |   |   |
| `mysql.advanced-docstore-collections.docCreateCollection` |   |   |
| `mysql.advanced-docstore-collections.docDropCollection` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-docstore-collections.docListCollections
- [ ] Ensure full coverage for mysql.advanced-docstore-collections.docCreateCollection
- [ ] Ensure full coverage for mysql.advanced-docstore-collections.docDropCollection
...
3. **Scope of fixes** includes corrections to any of:
   ...
   - Prompt generation logic (`test-server/scripts/prompt-template.md`, `test-server/scripts/tool-map.json`, or `test-server/scripts/standardize-prompts.js`) — run `bun test-server/scripts/generate-tests.ts` after editing.
