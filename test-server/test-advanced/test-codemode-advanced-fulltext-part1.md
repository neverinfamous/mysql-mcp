# MySQL MCP Advanced Stress Testing: [advanced-fulltext]
...
|---|---|---|
| `mysql.advanced-fulltext.fulltextCreate` |   |   |
| `mysql.advanced-fulltext.fulltextDrop` |   |   |
| `mysql.advanced-fulltext.fulltextSearch` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-fulltext.fulltextCreate
- [ ] Ensure full coverage for mysql.advanced-fulltext.fulltextDrop
- [ ] Ensure full coverage for mysql.advanced-fulltext.fulltextSearch
