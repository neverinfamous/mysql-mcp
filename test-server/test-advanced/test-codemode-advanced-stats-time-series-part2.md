...
|---|---|---|
| `mysql.advanced-stats-time-series.statsLagLead` |   |   |
| `mysql.advanced-stats-time-series.statsNtile` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-stats-time-series.statsLagLead
- [ ] Ensure full coverage for mysql.advanced-stats-time-series.statsNtile
