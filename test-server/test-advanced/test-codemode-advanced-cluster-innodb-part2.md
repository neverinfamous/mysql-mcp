...
|---|---|---|
| `mysql.advanced-cluster-innodb.clusterRouterStatus` |   |   |
| `mysql.advanced-cluster-innodb.clusterSwitchover` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-cluster-innodb.clusterRouterStatus
- [ ] Ensure full coverage for mysql.advanced-cluster-innodb.clusterSwitchover
