# MySQL MCP Advanced Stress Testing: [admin-control - part 2]
...
1. Pass string where number expected for all tools with numeric params
2. Pass number where string expected (e.g., `table: 123`)
3. Pass array where string expected
4. All must return structured errors, NOT raw MCP `-32602`
