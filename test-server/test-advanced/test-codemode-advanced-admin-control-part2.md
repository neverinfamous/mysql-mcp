...
|---|---|---|
| `mysql.advanced-admin-control.repairTable` |   |   |
| `mysql.advanced-admin-control.flushTables` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-admin-control.repairTable
- [ ] Ensure full coverage for mysql.advanced-admin-control.flushTables
