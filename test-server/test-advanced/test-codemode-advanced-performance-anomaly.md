# MySQL MCP Advanced Stress Testing: [advanced-performance-anomaly]
...
|---|---|---|
| `mysql.advanced-performance-anomaly.detectQueryAnomalies` |   |   |
| `mysql.advanced-performance-anomaly.detectBloatRisk` |   |   |
| `mysql.advanced-performance-anomaly.detectConnectionSpike` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-performance-anomaly.detectQueryAnomalies
- [ ] Ensure full coverage for mysql.advanced-performance-anomaly.detectBloatRisk
- [ ] Ensure full coverage for mysql.advanced-performance-anomaly.detectConnectionSpike
