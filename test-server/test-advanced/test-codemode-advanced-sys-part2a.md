# MySQL MCP Advanced Stress Testing: [advanced-sys]
...
|---|---|---|
| `mysql.advanced-sys.sysInnodbLockWaits` |   |   |
| `mysql.advanced-sys.sysSchemaStats` |   |   |
| `mysql.advanced-sys.sysHostSummary` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-sys.sysInnodbLockWaits
- [ ] Ensure full coverage for mysql.advanced-sys.sysSchemaStats
- [ ] Ensure full coverage for mysql.advanced-sys.sysHostSummary
