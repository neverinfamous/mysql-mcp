...
|---|---|---|
| `mysql.advanced-shell-utils.mysqlshVersion` |   |   |
| `mysql.advanced-shell-utils.mysqlshCheckUpgrade` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-shell-utils.mysqlshVersion
- [ ] Ensure full coverage for mysql.advanced-shell-utils.mysqlshCheckUpgrade
