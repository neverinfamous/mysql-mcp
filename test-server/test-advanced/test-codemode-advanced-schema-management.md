# MySQL MCP Advanced Stress Testing: [advanced-schema-management]
...
|---|---|---|
| `mysql.advanced-schema-management.listSchemas` |   |   |
| `mysql.advanced-schema-management.createSchema` |   |   |
| `mysql.advanced-schema-management.dropSchema` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-schema-management.listSchemas
- [ ] Ensure full coverage for mysql.advanced-schema-management.createSchema
- [ ] Ensure full coverage for mysql.advanced-schema-management.dropSchema
