...
|---|---|---|
| `mysql.advanced-docstore-collections.docCreateIndex` |   |   |
| `mysql.advanced-docstore-collections.docCollectionInfo` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-docstore-collections.docCreateIndex
- [ ] Ensure full coverage for mysql.advanced-docstore-collections.docCollectionInfo
