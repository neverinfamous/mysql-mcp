...
|---|---|---|
| `mysql.advanced-fulltext.fulltextBoolean` |   |   |
| `mysql.advanced-fulltext.fulltextExpand` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-fulltext.fulltextBoolean
- [ ] Ensure full coverage for mysql.advanced-fulltext.fulltextExpand
