# MySQL MCP Advanced Stress Testing: [advanced-backup-export]
...
|---|---|---|
| `mysql.advanced-backup-export.exportTable` |   |   |
| `mysql.advanced-backup-export.importData` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-backup-export.exportTable
- [ ] Ensure full coverage for mysql.advanced-backup-export.importData
