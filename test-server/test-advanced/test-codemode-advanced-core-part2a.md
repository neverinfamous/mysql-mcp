...
|---|---|---|
| `mysql.advanced-core.createIndex` |   |   |
| `mysql.advanced-core.getIndexes` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-core.createIndex
- [ ] Ensure full coverage for mysql.advanced-core.getIndexes
