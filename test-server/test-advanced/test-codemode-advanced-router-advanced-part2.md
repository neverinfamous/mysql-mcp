...
|---|---|---|
| `mysql.advanced-router-advanced.routerRouteHealth` |   |   |
| `mysql.advanced-router-advanced.routerRouteConnections` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-router-advanced.routerRouteHealth
- [ ] Ensure full coverage for mysql.advanced-router-advanced.routerRouteConnections
