# MySQL MCP Advanced Stress Testing: [advanced-shell-data]
...
|---|---|---|
| `mysql.advanced-shell-data.mysqlshExportTable` |   |   |
| `mysql.advanced-shell-data.mysqlshImportTable` |   |   |
| `mysql.advanced-shell-data.mysqlshImportJson` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-shell-data.mysqlshExportTable
- [ ] Ensure full coverage for mysql.advanced-shell-data.mysqlshImportTable
- [ ] Ensure full coverage for mysql.advanced-shell-data.mysqlshImportJson
