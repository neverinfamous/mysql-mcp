# MySQL MCP Advanced Stress Testing: [advanced-stats-advanced]
...
|---|---|---|
| `mysql.advanced-stats-advanced.statsCorrelation` |   |   |
| `mysql.advanced-stats-advanced.statsRegression` |   |   |
| `mysql.advanced-stats-advanced.statsSampling` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-stats-advanced.statsCorrelation
- [ ] Ensure full coverage for mysql.advanced-stats-advanced.statsRegression
- [ ] Ensure full coverage for mysql.advanced-stats-advanced.statsSampling
