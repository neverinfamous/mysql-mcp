# MySQL MCP Advanced Stress Testing: [advanced-cluster-group-replication]
...
|---|---|---|
| `mysql.advanced-cluster-group-replication.grStatus` |   |   |
| `mysql.advanced-cluster-group-replication.grMembers` |   |   |
| `mysql.advanced-cluster-group-replication.grPrimary` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-cluster-group-replication.grStatus
- [ ] Ensure full coverage for mysql.advanced-cluster-group-replication.grMembers
- [ ] Ensure full coverage for mysql.advanced-cluster-group-replication.grPrimary
