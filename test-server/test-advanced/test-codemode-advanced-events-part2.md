# MySQL MCP Advanced Stress Testing: [advanced-events]
...
|---|---|---|
| `mysql.advanced-events.eventList` |   |   |
| `mysql.advanced-events.eventStatus` |   |   |
| `mysql.advanced-events.schedulerStatus` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-events.eventList
- [ ] Ensure full coverage for mysql.advanced-events.eventStatus
- [ ] Ensure full coverage for mysql.advanced-events.schedulerStatus
