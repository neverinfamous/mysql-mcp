...
|---|---|---|
| `mysql.advanced-events.eventCreate` |   |   |
| `mysql.advanced-events.eventAlter` |   |   |
| `mysql.advanced-events.eventDrop` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-events.eventCreate
- [ ] Ensure full coverage for mysql.advanced-events.eventAlter
- [ ] Ensure full coverage for mysql.advanced-events.eventDrop
