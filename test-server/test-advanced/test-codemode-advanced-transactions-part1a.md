...
|---|---|---|
| `mysql.advanced-transactions.transactionBegin` |   |   |
| `mysql.advanced-transactions.transactionCommit` |   |   |
| `mysql.advanced-transactions.transactionRollback` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-transactions.transactionBegin
- [ ] Ensure full coverage for mysql.advanced-transactions.transactionCommit
- [ ] Ensure full coverage for mysql.advanced-transactions.transactionRollback
