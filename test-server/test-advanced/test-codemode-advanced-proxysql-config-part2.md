# MySQL MCP Advanced Stress Testing: [advanced-proxysql-config]
...
|---|---|---|
| `mysql.advanced-proxysql-config.proxysqlQueryDigest` |   |   |
| `mysql.advanced-proxysql-config.proxysqlConnectionPool` |   |   |
| `mysql.advanced-proxysql-config.proxysqlUsers` |   |   |
...
- [ ] Ensure full coverage for mysql.advanced-proxysql-config.proxysqlQueryDigest
- [ ] Ensure full coverage for mysql.advanced-proxysql-config.proxysqlConnectionPool
- [ ] Ensure full coverage for mysql.advanced-proxysql-config.proxysqlUsers
