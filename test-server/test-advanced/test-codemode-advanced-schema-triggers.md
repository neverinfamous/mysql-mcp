# mysql-mcp Advanced Stress Testing: [schema-triggers]
...
| `mysql_create_trigger` | UNAVAILABLE - WARN USER | N/A |
| `mysql_drop_trigger` | UNAVAILABLE - WARN USER | N/A |

## Post-Test Cleanup
Drop all `stress_*` schemas and triggers.
---
