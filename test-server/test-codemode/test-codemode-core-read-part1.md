...
|---|---|---|
| `mysql.core-read.readQuery` |   |   |
| `mysql.core-read.listTables` |   |   |
...
> **API Reference**: You MUST read the `mysql://help/core-read` resource (or view `src/constants/server-instructions/core-read.md`) to understand the exact API signatures and expected parameters before writing any code.

## Tasks

- [ ] Ensure full coverage for mysql.core-read.readQuery
- [ ] Ensure full coverage for mysql.core-read.listTables
