...
> **API Reference**: You MUST read the `mysql://help/stats` resource (or view `src/constants/server-instructions/stats.md`) to understand the exact API signatures and expected parameters before writing any code.
