...
> **API Reference**: You MUST read the `mysql://help/roles` resource (or view `src/constants/server-instructions/roles.md`) to understand the exact API signatures and expected parameters before writing any code.
