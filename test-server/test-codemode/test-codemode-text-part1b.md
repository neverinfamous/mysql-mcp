...
> **API Reference**: You MUST read the `mysql://help/text` resource (or view `src/constants/server-instructions/text.md`) to understand the exact API signatures and expected parameters before writing any code.
