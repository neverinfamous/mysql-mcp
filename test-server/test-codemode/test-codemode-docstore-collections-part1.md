...
> **API Reference**: You MUST read the `mysql://help/docstore` resource (or view `src/constants/server-instructions/docstore.md`) to understand the exact API signatures and expected parameters before writing any code.
