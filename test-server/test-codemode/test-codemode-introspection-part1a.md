...
> **API Reference**: You MUST read the `mysql://help/introspection` resource (or view `src/constants/instructions/markdown/introspection.md`) to understand the exact API signatures and expected parameters before writing any code.
