...
> **API Reference**: You MUST read the `mysql://help/performance` resource (or view `src/constants/server-instructions/performance.md`) to understand the exact API signatures and expected parameters before writing any code.
