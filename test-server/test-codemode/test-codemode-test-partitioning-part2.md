...
> **API Reference**: You MUST read the `mysql://help/partitioning` resource (or view `src/constants/instructions/markdown/partitioning.md`) to understand the exact API signatures and expected parameters before writing any code.
