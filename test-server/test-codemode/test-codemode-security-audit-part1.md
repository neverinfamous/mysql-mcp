...
> **API Reference**: You MUST read the `mysql://help/security` resource (or view `src/constants/instructions/markdown/security.md`) to understand the exact API signatures and expected parameters before writing any code.
