...
> **API Reference**: You MUST read the `mysql://help/vector` resource (or view `src/constants/server-instructions/vector.md`) to understand the exact API signatures and expected parameters before writing any code.
