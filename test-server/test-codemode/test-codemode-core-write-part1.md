...
|---|---|---|
| `mysql.core-write.writeQuery` |   |   |
| `mysql.core-write.createTable` |   |   |
...
> **API Reference**: You MUST read the `mysql://help/core-write` resource (or view `src/constants/server-instructions/core-write.md`) to understand the exact API signatures and expected parameters before writing any code.

## Tasks

- [ ] Ensure full coverage for mysql.core-write.writeQuery
- [ ] Ensure full coverage for mysql.core-write.createTable
