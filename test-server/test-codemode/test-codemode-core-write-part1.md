...
> **API Reference**: You MUST read the `mysql://help/core-write` resource (or view `src/constants/instructions/markdown/core-write.md`) to understand the exact API signatures and expected parameters before writing any code.
