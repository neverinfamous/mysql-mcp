...
> **API Reference**: You MUST read the `mysql://help/codemode` resource (or view `src/constants/server-instructions/codemode.md`) to understand the exact API signatures and expected parameters before writing any code.
