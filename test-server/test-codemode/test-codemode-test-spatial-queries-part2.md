...
> **API Reference**: You MUST read the `mysql://help/spatial` resource (or view `src/constants/instructions/markdown/spatial.md`) to understand the exact API signatures and expected parameters before writing any code.
