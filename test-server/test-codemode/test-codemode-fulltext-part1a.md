...
> **API Reference**: You MUST read the `mysql://help/fulltext` resource (or view `src/constants/server-instructions/fulltext.md`) to understand the exact API signatures and expected parameters before writing any code.
