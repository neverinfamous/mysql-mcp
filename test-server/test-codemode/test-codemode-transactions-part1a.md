...
> **API Reference**: You MUST read the `mysql://help/transactions` resource (or view `src/constants/server-instructions/transactions.md`) to understand the exact API signatures and expected parameters before writing any code.
