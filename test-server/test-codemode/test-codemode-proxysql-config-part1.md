...
> **API Reference**: You MUST read the `mysql://help/proxysql` resource (or view `src/constants/instructions/markdown/proxysql.md`) to understand the exact API signatures and expected parameters before writing any code.
