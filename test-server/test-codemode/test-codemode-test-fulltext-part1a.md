...
> **API Reference**: You MUST read the `mysql://help/fulltext` resource (or view `src/constants/instructions/markdown/fulltext.md`) to understand the exact API signatures and expected parameters before writing any code.
