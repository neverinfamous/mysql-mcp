...
> **API Reference**: You MUST read the `mysql://help/schema` resource (or view `src/constants/instructions/markdown/schema.md`) to understand the exact API signatures and expected parameters before writing any code.
