...
> **API Reference**: You MUST read the `mysql://help/events` resource (or view `src/constants/server-instructions/events.md`) to understand the exact API signatures and expected parameters before writing any code.
