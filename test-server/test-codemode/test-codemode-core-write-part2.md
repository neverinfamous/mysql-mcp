...
|---|---|---|
| `mysql.core-write.dropTable` |   |   |
| `mysql.core-write.createIndex` |   |   |
...
- [ ] Ensure full coverage for mysql.core-write.dropTable
- [ ] Ensure full coverage for mysql.core-write.createIndex
