...
> **API Reference**: You MUST read the `mysql://help/monitoring` resource (or view `src/constants/server-instructions/monitoring.md`) to understand the exact API signatures and expected parameters before writing any code.
