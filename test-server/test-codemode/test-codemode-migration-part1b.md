...
> **API Reference**: You MUST read the `mysql://help/migration` resource (or view `src/constants/instructions/markdown/migration.md`) to understand the exact API signatures and expected parameters before writing any code.
