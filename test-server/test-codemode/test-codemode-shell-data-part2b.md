...
> **API Reference**: You MUST read the `mysql://help/shell` resource (or view `src/constants/server-instructions/shell.md`) to understand the exact API signatures and expected parameters before writing any code.
