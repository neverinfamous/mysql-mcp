...
> **API Reference**: You MUST read the `mysql://help/cluster` resource (or view `src/constants/server-instructions/cluster.md`) to understand the exact API signatures and expected parameters before writing any code.
