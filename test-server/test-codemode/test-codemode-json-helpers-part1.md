...
> **API Reference**: You MUST read the `mysql://help/json` resource (or view `src/constants/server-instructions/json.md`) to understand the exact API signatures and expected parameters before writing any code.
