# MySQL MCP Code Mode Testing: [sysschema]
...
> **API Reference**: You MUST read the `mysql://help/sysschema` resource (or view `src/constants/server-instructions/sysschema.md`) to understand the exact API signatures and expected parameters before writing any code.
