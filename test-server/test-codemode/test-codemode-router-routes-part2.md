...
> **API Reference**: You MUST read the `mysql://help/router` resource (or view `src/constants/server-instructions/router.md`) to understand the exact API signatures and expected parameters before writing any code.
