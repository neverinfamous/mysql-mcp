...
> **API Reference**: You MUST read the `mysql://help/optimization` resource (or view `src/constants/instructions/markdown/optimization.md`) to understand the exact API signatures and expected parameters before writing any code.
