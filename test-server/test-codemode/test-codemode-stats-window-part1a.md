...
> **API Reference**: You MUST read the `mysql://help/stats` resource (or view `src/constants/instructions/markdown/stats.md`) to understand the exact API signatures and expected parameters before writing any code.
