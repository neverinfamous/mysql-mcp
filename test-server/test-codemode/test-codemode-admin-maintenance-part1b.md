...
> **API Reference**: You MUST read the `mysql://help/admin` resource (or view `src/constants/instructions/markdown/admin.md`) to understand the exact API signatures and expected parameters before writing any code.
