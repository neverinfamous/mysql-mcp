...
- **Performance**: Added missing `metrics.tokenEstimate` payloads in success and domain error paths across all performance tools (`mysql_explain`, `mysql_explain_analyze`, `mysql_slow_queries`, `mysql_query_stats`, `mysql_index_usage`, `mysql_table_stats`, `mysql_buffer_pool_stats`, `mysql_thread_stats`, `mysql_detect_query_anomalies`, `mysql_detect_bloat_risk`, `mysql_detect_connection_spike`).
