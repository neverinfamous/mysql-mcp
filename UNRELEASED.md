...
- **Tests**: Remediated benchmark timing assertions, fixed `vitest bench` watch-mode hangs, gracefully skipped E2E write tests in read-only mode, and certified `fulltext` tool group using 12-point Code Mode stress tests.
