...
## Fixed
- **Structured Error Compliance**: Unified and hardened domain error reporting across Backup and Admin tool groups to strictly adhere to the `ErrorResponse` schema (Pattern P154).
