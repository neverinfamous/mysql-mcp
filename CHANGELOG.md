...
This project uses `bun ./.agents/scripts/commit.ts` to enforce a single-source-of-truth Git commit strategy. The wrapper embeds changelog entries and release notes into the Git commit history. The release process compiles them automatically.
