...
You are auditing documentation for the **mysql-mcp** project. This premier TypeScript MCP server for MySQL databases empowers LLMs with 241 specialized tools. It features 23 resources and 19 prompts. Verify documentation accuracy. Ensure consistency with recent changes.
