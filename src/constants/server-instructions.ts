...
- **Introspection**: \`mysql_list_stored_procedures\`, \`mysql_list_functions\`, \`mysql_list_triggers\` enumerate database objects. Most accept an optional \`schema\` parameter for cross-database inspection, except \`mysql_list_triggers\` which requires it. \`mysql_list_triggers\` also accepts optional \`table\` parameter to filter by table name. Returns a structured error \`{ success: false, error: ... }\` when the specified table does not exist.
