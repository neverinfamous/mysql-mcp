...
Tools: \`mysql_list_schemas\`, \`mysql_create_schema\`, \`mysql_drop_schema\`, \`mysql_list_views\`, \`mysql_create_view\`, \`mysql_drop_view\`, \`mysql_list_constraints\`, \`mysql_list_stored_procedures\`, \`mysql_list_functions\`, \`mysql_list_triggers\`
