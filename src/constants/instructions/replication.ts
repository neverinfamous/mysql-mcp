export const REPLICATION_HELP = `# Replication Tools

**Encapsulated Tools**: \`mysql_master_status\`, \`mysql_slave_status\`, \`mysql_binlog_events\`, \`mysql_gtid_status\`, \`mysql_replication_lag\`
...
- **Replication lag**: \`mysql_replication_lag\` calculates delay in seconds. Supports optional \`channel\` parameter for multi-source replication. Returns \`lagSeconds: null\` if not a replica.`;
