export const ROLES_HELP = `# Role Management

**Encapsulated Tools**: \`mysql_role_list\`, \`mysql_role_create\`, \`mysql_role_drop\`, \`mysql_role_grants\`, \`mysql_role_grant\`, \`mysql_role_assign\`, \`mysql_role_revoke\`, \`mysql_user_roles\`
