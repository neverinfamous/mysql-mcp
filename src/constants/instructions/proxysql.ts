export const PROXYSQL_HELP = `# ProxySQL Tools
...
- **Global variables**: \`proxysql_global_variables\` supports \`like\` pattern. Use \`limit\` (default: 10). Uses credential redaction for passwords.
