...
- **Index usage**: \`mysql_index_usage\` filters to the current database by default. Use \`table\` parameter to filter further. Use \`limit\` (default: 20) to cap results. Returns \`{ exists: false, table }\` when the specified table does not exist.
