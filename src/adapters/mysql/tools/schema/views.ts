...
const CreateViewSchema = z.object({
    ...
    algorithm: z.enum(['UNDEFINED', 'MERGE', 'TEMPTABLE']).default('UNDEFINED').describe('View algorithm'),
    checkOption: z.enum(['NONE', 'CASCADED', 'LOCAL']).default('NONE').describe('WITH CHECK OPTION')
});
...
export function createListViewsTool(adapter: MySQLAdapter): ToolDefinition {
    return {
        ...
        description: 'List all views with their definitions, security type, and check option.',
        group: 'schema',
