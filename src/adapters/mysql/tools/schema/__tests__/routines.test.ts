...
import { createListStoredProceduresTool, createListFunctionsTool } from '../routines.js';
...
describe('Schema Routine Tools', () => {
    ...
    describe('mysql_list_stored_procedures', () => {
        it('should query INFORMATION_SCHEMA for routines', async () => {
            ...
            const tool = createListStoredProceduresTool(mockAdapter as unknown as MySQLAdapter);
    ...
    describe('mysql_list_functions', () => {
        it('should query INFORMATION_SCHEMA for functions', async () => {
            ...
            const tool = createListFunctionsTool(mockAdapter as unknown as MySQLAdapter);
            const result = await tool.handler({}, mockContext);
