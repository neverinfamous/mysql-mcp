    ...
    return {
        ...
        handler: async (params: unknown, _context: RequestContext) => {
            ...
            return {
                ...
                message: 'Transaction started. Use transactionId for commit/rollback operations.'
            };
        }
    };
}
...
function createTransactionCommitTool(adapter: MySQLAdapter): ToolDefinition {
    return {
        ...
        handler: async (params: unknown, _context: RequestContext) => {
            ...
            return { success: true, transactionId, message: 'Transaction committed successfully.' };
        }
    };
}
...
function createTransactionRollbackTool(adapter: MySQLAdapter): ToolDefinition {
    return {
        ...
        handler: async (params: unknown, _context: RequestContext) => {
            ...
            return { success: true, transactionId, message: 'Transaction rolled back.' };
        }
    };
}
...
function createTransactionReleaseTool(adapter: MySQLAdapter): ToolDefinition {
    return {
        ...
        handler: async (params: unknown, _context: RequestContext) => {
            ...
            return { success: true, transactionId, savepoint, message: 'Savepoint released.' };
        }
    };
}
...
function createTransactionRollbackToTool(adapter: MySQLAdapter): ToolDefinition {
    return {
        ...
        handler: async (params: unknown, _context: RequestContext) => {
            ...
            return { success: true, transactionId, savepoint, message: 'Rolled back to savepoint.' };
        }
    };
}
    ...
    return {
        ...
        handler: async (params: unknown, _context: RequestContext) => {
            ...
            try {
                ...
                await adapter.rollbackTransaction(transactionId);
                throw new Error(`Transaction failed and was rolled back: ${String(error)}`);
            }
        }
    };
}
