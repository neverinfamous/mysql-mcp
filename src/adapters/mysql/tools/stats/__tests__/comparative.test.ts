...
import { createCorrelationTool, createRegressionTool, createHistogramTool } from '../comparative.js';
...
describe('Comparative Stats Tools', () => {
    ...
    describe('mysql_stats_correlation', () => {
        ...
        it('should validate inputs', async () => {
            await expect(correlationTool.handler({
                table: 'bad;table',
                column1: 'x',
                column2: 'y'
            }, {} as any)).rejects.toThrow('Invalid table name');
        });
    });
    ...
    describe('mysql_stats_histogram', () => {
        it('should handle update', async () => {
            ...
            expect(mockAdapter.executeQuery).toHaveBeenCalledWith(expect.stringContaining('ANALYZE TABLE'));
