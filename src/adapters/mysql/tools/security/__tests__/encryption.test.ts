...
import { createSecuritySSLStatusTool, createSecurityEncryptionStatusTool, createSecurityPasswordValidateTool } from '../encryption.js';
...
describe('Security Encryption Tools', () => {
    ...
    describe('mysql_security_password_validate', () => {
        it('should validate password strength', async () => {
            ...
            const result = await tool.handler({ password: 'StrongPassword123!' }, {} as any) as any;
        ...
        it('should handle weak passwords', async () => {
            ...
            const result = await tool.handler({ password: '123' }, {} as any) as any;
        ...
        it('should handle component not installed error', async () => {
            ...
            const result = await tool.handler({ password: 'pass' }, {} as any) as any;
