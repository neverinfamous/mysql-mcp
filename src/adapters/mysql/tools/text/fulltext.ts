...
export function createFulltextCreateTool(adapter: MySQLAdapter): ToolDefinition {
    return {
...
export function createFulltextSearchTool(adapter: MySQLAdapter): ToolDefinition {
    return {
...
export function createFulltextBooleanTool(adapter: MySQLAdapter): ToolDefinition {
...
export function createFulltextExpandTool(adapter: MySQLAdapter): ToolDefinition {
    const schema = z.object({
        table: z.string(),
        columns: z.array(z.string()),
