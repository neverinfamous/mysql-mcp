...
describe('Spatial Geometry Tools', () => {
    ...
    describe('createSpatialPointTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSpatialPointTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should create point from coordinates', async () => {
            ...
            const tool = createSpatialPointTool(mockAdapter as unknown as MySQLAdapter);
            const result = await tool.handler({ longitude: 10, latitude: 20 }, mockContext) as { wkt: string; geoJson: any };
        ...
        it('should handle custom SRID', async () => {
            ...
            const tool = createSpatialPointTool(mockAdapter as unknown as MySQLAdapter);
            await tool.handler({ longitude: 10, latitude: 20, srid: 3857 }, mockContext);
    ...
    describe('createSpatialPolygonTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSpatialPolygonTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should create polygon from coordinates', async () => {
            ...
            const result = await tool.handler({ coordinates }, mockContext) as { wkt: string; area: number };
