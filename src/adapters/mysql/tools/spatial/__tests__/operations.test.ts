...
describe('Spatial Operations Tools', () => {
    ...
    describe('createSpatialIntersectionTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSpatialIntersectionTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should calculate intersection', async () => {
            ...
            const result = await tool.handler({
                geometry1: 'POLYGON(...)',
                geometry2: 'POINT(5 5)'
            }, mockContext) as { intersects: boolean; intersectionWkt: string };
        ...
        it('should handle no intersection', async () => {
            ...
            }, mockContext) as { intersects: boolean };
    ...
    describe('createSpatialBufferTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSpatialBufferTool(mockAdapter as unknown as MySQLAdapter);
    ...
    describe('createSpatialTransformTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSpatialTransformTool(mockAdapter as unknown as MySQLAdapter);
    ...
    describe('createSpatialGeoJSONTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSpatialGeoJSONTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should convert WKT to GeoJSON', async () => {
            ...
            const tool = createSpatialGeoJSONTool(mockAdapter as unknown as MySQLAdapter);
            const result = await tool.handler({ geometry: 'POINT(10 20)' }, mockContext) as { geoJson: any };
        ...
        it('should convert GeoJSON to WKT', async () => {
            ...
            const tool = createSpatialGeoJSONTool(mockAdapter as unknown as MySQLAdapter);
            const result = await tool.handler({ geoJson: '{"type":"Point","coordinates":[10,20]}' }, mockContext) as { wkt: string };
