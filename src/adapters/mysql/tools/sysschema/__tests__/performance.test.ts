...
describe('Sys Schema Performance Tools', () => {
    ...
    describe('createSysStatementSummaryTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSysStatementSummaryTool(mockAdapter as unknown as MySQLAdapter);
    ...
    describe('createSysWaitSummaryTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSysWaitSummaryTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should query by instance', async () => {
            ...
            const call = mockAdapter.executeQuery.mock.calls[0][0] as string;
            expect(call).toContain('performance_schema.events_waits_summary_by_instance');
        });
    });
