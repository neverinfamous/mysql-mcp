...
describe('Sys Schema Activity Tools', () => {
    ...
    describe('createSysUserSummaryTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSysUserSummaryTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should query user summary', async () => {
            ...
            const tool = createSysUserSummaryTool(mockAdapter as unknown as MySQLAdapter);
            const result = await tool.handler({ limit: 10 }, mockContext) as { users: unknown[] };
    ...
    describe('createSysHostSummaryTool', () => {
        it('should create tool with correct definition', () => {
            const tool = createSysHostSummaryTool(mockAdapter as unknown as MySQLAdapter);
        ...
        it('should query host summary', async () => {
            ...
            const tool = createSysHostSummaryTool(mockAdapter as unknown as MySQLAdapter);
            const result = await tool.handler({}, mockContext) as { hosts: unknown[] };
