...
export const ConcatSchema = z
  .preprocess(
    ...
    z.object({
      ...
      tableName: z.string().optional(),
      name: z.string().optional(),
      columns: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v : (typeof v === "string" && v.includes(",") ? v.split(",").map(s => s.trim()) : [v])).optional(),
      cols: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v : (typeof v === "string" && v.includes(",") ? v.split(",").map(s => s.trim()) : [v])).optional(),
      column: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v : (typeof v === "string" && v.includes(",") ? v.split(",").map(s => s.trim()) : [v])).optional(),
