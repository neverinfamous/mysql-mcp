...
export const CollationConvertSchema = z
  .preprocess(
    ...
    z.object({
      ...
      column: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v[0] : v).optional(),
      cols: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v[0] : v).optional(),
      columns: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v[0] : v).optional(),
      col: z.union([z.array(z.string()), z.string()]).transform(v => Array.isArray(v) ? v[0] : v).optional(),
