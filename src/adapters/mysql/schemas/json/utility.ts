...
export const JsonNormalizeSchemaBase = z.object({
  table: z.string().describe("Table name (Anti-Hallucination: Pass 'table', not 'tableName'). Note: This tool normalizes an existing JSON column in a table, it does not normalize raw JSON strings."),
...
export const JsonValidateSchemaBase = z.object({
  value: z.unknown().describe("JSON string to validate (Anti-Hallucination: Pass 'value', not 'json' or 'data')"),
...
export const JsonMergeSchemaBase = z.object({
  json1: z.unknown().describe("First JSON document (Anti-Hallucination: Pass 'json1', not 'doc1' or 'target'). Note: This tool merges two raw JSON documents in-memory. It does NOT update database tables. Use mysql_json_update or mysql_json_set to update a table."),
  doc1: z.unknown().optional().describe("Alias for json1"),
  target: z.unknown().optional().describe("Alias for json1"),
  json2: z.unknown().describe("Second JSON document (Anti-Hallucination: Pass 'json2', not 'doc2' or 'source')"),
...
export const JsonDiffSchemaBase = z.object({
  json1: z.unknown().describe("First JSON document (Anti-Hallucination: Pass 'json1', not 'doc1' or 'target'). Note: This tool compares two raw JSON documents, it does NOT compare database rows."),
  doc1: z.unknown().optional().describe("Alias for json1"),
  target: z.unknown().optional().describe("Alias for json1"),
  json2: z.unknown().describe("Second JSON document (Anti-Hallucination: Pass 'json2', not 'doc2' or 'source')"),
  doc2: z.unknown().optional().describe("Alias for json2"),
