...
describe("Performance Tests", () => {
  describe("getAllToolNames caching", () => {
    ...
    it("should return consistent count of 223 tools", () => {
  ...
  describe("parseToolFilter performance", () => {
    ...
    it("should parse complex filter chain efficiently", () => {
      const complexFilter =
        "-base-core,-base-admin,-ecosystem,+starter,+spatial,+performance";
    ...
    it("should correctly filter to expected tool counts", () => {
      ...
      expect(devPowerConfig.enabledTools.size).toBe(62);
    });
    ...
    describe("MySQLAdapter tool definition caching", () => {
      it("should cache tool definitions after first call", () => {
        ...
        expect(firstCall).toHaveLength(223);
      ...
      it("should return consistent tool count of 223 regardless of filter default", () => {
        const adapter = new MySQLAdapter();
