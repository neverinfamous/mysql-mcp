...
import type { PoolConnection, FieldPacket, ResultSetHeader, Pool } from 'mysql2/promise';
 ...
 */
export function createMockResultSetHeader(affectedRows = 1, insertId = 0): ResultSetHeader {
    return {
...
export function setupMockQueryResponse(
    ...
    const mockImplementation = (sql: string): Promise<[unknown[], FieldPacket[]]> => {
