 ...
 * extends MySQLMcpError for full category/suggestion/toResponse() support.
 */
 ...
 */
export class OAuthError extends MySQLMcpError {
...
export class TokenMissingError extends OAuthError {
  constructor(message = "No bearer token provided") {
    super(message, "TOKEN_MISSING", 401, {
      wwwAuthenticate: `Bearer realm="mysql-mcp"`,
    });
