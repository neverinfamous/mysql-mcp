...
- `datadog-ai-dashboard.json`: The **AI Efficiency** dashboard. Tracks cost metrics, cache hit rates, connection pooling efficiency, MySQL Shell metrics, and the `MySQL Shell Status` widget (`.fill(last)`).
